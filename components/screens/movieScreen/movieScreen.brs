...
'============= ON LOADING LANDSCAPE IMG HIGH ========'
sub onLoadingLanscapeImgHigh()
  if m.landscapeImgHigh.loadStatus = "ready"
...
sub getCategories()
  ...
  m.apiController.getCategories(platform, "onGetCategories")
end sub


'============== ON GET CATEGORIES ===========
function onGetCategories(pEvent as dynamic) as boolean
...
function onKeyEvent(key as string, press as boolean) as boolean
  'print "onKeyEvent MovieScreen ";key;" "; press
  ...
  if  m.taskInProgress
    ...
    if key = "back"
      ...
      if m.col > 0
          m.col = 0
          m.rowlist.jumpToRowItem = [m.row, m.col]
          return true
      end if 
